...
# - column_0: location to validate (it can be alpha2, alpha3 or location's name)
# - column_1: expected alpha2 code
# - column_2: expected alpha3 code
# - column_3: expected location name
...
class TestCountryCleaner(unittest.TestCase):
    """
    This is the TestCase class that tests cleaning functions for location information.
    """
    ...
    def test_validate_countries(self):
        ...
        country_cleaner.lettercase_output = base_cleaner.LOWER_LETTER_CASE
